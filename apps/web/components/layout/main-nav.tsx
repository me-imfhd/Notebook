...
import { NavigationMenu, NavigationMenuContent, NavigationMenuItem, NavigationMenuLink, NavigationMenuList, NavigationMenuTrigger, navigationMenuTriggerStyle } from "@notebook/ui/components";
  ...
  return (
    <div className="hidden gap-6 lg:flex">
      ...
      >
        ...
        <span className="hidden font-bold lg:inline-block">Notebook</span>
      </a>
      <NavigationMenu>
        <NavigationMenuList>
          <NavigationMenuItem>
