...
read -p "Please enter your GOOGLE_CLIENT_SECRET API key (press enter to skip): " GOOGLE_CLIENT_SECRET
echo "GOOGLE_CLIENT_SECRET=$GOOGLE_CLIENT_SECRET" >> .env
read -p "Please enter your DISCORD_CLIENT_ID API key (press enter to skip): " DISCORD_CLIENT_ID
echo "DISCORD_CLIENT_ID=$DISCORD_CLIENT_ID" >> .env
read -p "Please enter your DISCORD_CLIENT_SECRET API key (press enter to skip): " DISCORD_CLIENT_SECRET
echo "DISCORD_CLIENT_SECRET=$DISCORD_CLIENT_SECRET" >> .env
read -p "Please enter your FACEBOOK_CLIENT_ID API key (press enter to skip): " FACEBOOK_CLIENT_ID
echo "FACEBOOK_CLIENT_ID=$FACEBOOK_CLIENT_ID" >> .env
read -p "Please enter your FACEBOOK_CLIENT_SECRET API key (press enter to skip): " FACEBOOK_CLIENT_SECRET
