import {
  ...
  deleteAllComputers,
  updateComputer,
} from "@notebook/api/api-endpoint-blogic/computers/mutations";
import { publicProcedure, createTRPCRouter, protectedProcedure } from "../trpc";
import { getComputers } from "@notebook/api/api-endpoint-blogic/computers/queries";
import { z } from "zod";
import {
  computerIdSchema,
  insertComputerParams,
  updateComputerParams,
} from "@notebook/db/schema/computers";
import { computerSchema } from "@notebook/db";
